...
public class SlaveDataSourceConfig {
	static final String MAPPER_PACKAGE = "com.funbox.project.dao.oracle";
	...
	public Interceptor pageHelperInit() {
		...
		//p.setProperty("mappers", "tk.mybatis.mapper.common.MyMapper,learn.zxl.boot.util.mybatis.provider.DemoProvider");
