...
public class RandomUtil {
    ...
    public static void main(String[] args) {
        System.out.println("type=i:" + new RandomUtil().getRandomString(32, "i"));
        System.out.println("type=il:" + new RandomUtil().getRandomString(32, "il"));
        System.out.println("type=ilu:" + new RandomUtil().getRandomString(32, "ilu"));
        System.out.println("type=ilus:" + new RandomUtil().getRandomString(32, "ilus"));
        System.out.println("type=ilus:" + new RandomUtil().getRandomString(4, "i"));
    }
