...
import com.funbox.project.dao.mysql.AppOrderMainMapper;
...
@Service
@Transactional
public class AppOrderMainServiceImpl extends AbstractService<AppOrderMain> implements AppOrderMainService {
    @Resource
    private AppOrderMainMapper appOrderMainMapper;
